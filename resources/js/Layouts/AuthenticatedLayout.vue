              ...
              >
                ...
                >
                  <path
                    clip-rule="evenodd"
                    fill-rule="evenodd"
                    d="M2 4.75A.75.75 0 012.7  5 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"
                  ></path>
                </svg>
              </button>
              <!-- <h1
                class="text-2xl lg:text-3xl font-bold transition duration-300"
              >
                <img
                  :src="`/storage/${settings?.logo}`"
                  alt="Logo"
                  class="h-8 sm:h-10 lg:h-12 max-w-full"
                />
              </h1> -->
            </div>
          ...
          <ul class="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span
                  class="inline-flex items-center justify-center w-4 h-4 p-3 ms-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300"
                  >{{ auth?.chats_count || 0 }}</span
                >
              </Link>
            </li>
            <li>
            ...
            <li>
              ...
              <ul id="dropdown-example" class="hidden py-2 space-y-2">
                ...
                <li>
                  <Link
                    :href="route('posts.index',{type:'capability'})"
                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                  >
                  capabilities</Link
                  >
