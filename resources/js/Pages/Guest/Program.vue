<template>
    <section
      ...
      ref="section"
    >
      <div class="container animate__animated animate__fadeInUp mx-auto max-w-6xl py-20 text-center space-y-12 z-20" :class="{ 'animate__animated': animate, 'animate__fadeInDown': animate }">
        <!-- Section Title -->
        <h2
