                    ...
                    <form class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input name="username" type="text" required v-model="form.email"
                        ...
                        <div>
                            ...
                            <div class="relative flex items-center">
                                <input :type="isPasswordVisible ? 'text' : 'password'" v-model="form.password" required
                                    class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-lg outline-blue-600"
                                    placeholder="Enter password" />
                                <svg xmlns="http://www.w3.org/2000/svg" :fill="isPasswordVisible ? '#4A90E2' : '#bbb'"
                                    :stroke="isPasswordVisible ? '#4A90E2' : '#bbb'"
