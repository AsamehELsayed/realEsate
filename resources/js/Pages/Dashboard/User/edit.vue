        ...
        <div class="flex flex-col">
            <div class="flex flex-col md:flex-row justify-between mb-5 items-start">
                ...
                <div class="text-center">
                    ...
                    <button @click="triggerFileInput" class="bg-indigo-800 text-white px-4 py-2 rounded-lg hover:bg-indigo-900 transition-colors duration-300 ring ring-gray-300 hover:ring-indigo-300">
            ...
            <form @submit.prevent="submitForm" class="space-y-4">
                ...
                <div class="flex justify-end space-x-4">
                    <button @click="submitForm" type="submit" class="px-4 py-2 bg-indigo-800 text-white rounded-lg hover:bg-indigo-700">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
